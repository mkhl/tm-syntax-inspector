...
struct iterator_observer {
    ...
    struct vector<unichar, std::allocator<unichar>> _field11;
...
struct kill_buffer_t {
    struct vector<unichar, std::allocator<unichar>> data;
    unsigned int memento;
...
struct view {
    ...
    struct tokenize_filter _field26;
    struct bookmark_filter _field27;
...
- (id)iconForFile:(id)fp8 isModified:(BOOL)fp12;
...
+ (id)regexpMatchWithCaptures:(const struct map<int, std::pair<int, int>, std::less<int>, std::allocator<std::pair<const int, std::pair<int, int>>>> *)fp8;
- (id)initWithCaptures:(const struct map<int, std::pair<int, int>, std::less<int>, std::allocator<std::pair<const int, std::pair<int, int>>>> *)fp8;
- (void)dealloc;
...
+ (void)initialize;
+ (id)sharedInstance;
- (void)resetTrialPeriod:(id)fp8;
- (id)init;
- (BOOL)canRegister;
- (id)ownerPortrait;
- (void)setOwner:(id)fp8;
- (void)setLicenseKey:(id)fp8;
- (void)setLicenseInfo:(const struct map<std::basic_string<char, std::char_traits<char>, std::allocator<char>>, std::basic_string<char, std::char_traits<char>, std::allocator<char>>, std::less<std::basic_string<char, std::char_traits<char>, std::allocator<char>>>, std::allocator<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char>>, std::basic_string<char, std::char_traits<char>, std::allocator<char>>>>> *)fp8;
- (int)orderFrontRegistrationPanel:(id)fp8;
...
- (struct _NSPoint)iteratorPosition:(const struct view_iterator *)fp8;
...
- (void)selectMisspelledWordAt:(const struct iterator *)fp8;
- (id)contextMenu;
- (id)menuForEvent:(id)fp8;
...
- (id)scopeForContext:(const struct storage *)fp8;
- (id)stylesForContext:(const struct storage *)fp8;
- (struct storage *)graphPathForIterator:(const struct iterator *)fp8;
- (struct storage *)graphPathForCaretWait:(BOOL)fp8;
- (id)currentContext;
...
- (id)draggedFileExtensions;
- (void)setScopeSelector:(id)fp8;
- (const struct basic_string<char, std::char_traits<char>, std::allocator<char>> *)scopeSelectorCString;
- (void)setKeyEquivalent:(id)fp8;
- (void)setTabTrigger:(id)fp8;
